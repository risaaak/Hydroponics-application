...
DROP PROCEDURE MONTHLYFINANCEPROCEDURE
EXEC MONTHLYFINANCEPROCEDURE
select * from monthlyincometemp
select * from MONTHLYEXPENSETEMP
SELECT * FROM MONTHLYFINANCE
drop table MONTHLYFINANCE
DROP TABLE MONTHLYINCOMETEMP